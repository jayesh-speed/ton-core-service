...
@Setter
@Builder
@Table(name = TableNames.TON_SWEEP_TX)
@NoArgsConstructor
@AllArgsConstructor
public class TonSweepTx extends IdentityJpaDomain {
	...
	@Column(name = DbFields.MAIN_NET, nullable = false, columnDefinition = "TINYINT(1)")
	private boolean mainNet;

	@Column(name = DbFields.CHAIN_ID, nullable = false, columnDefinition = "TINYINT UNSIGNED")
	private Integer chainId;

	@Column(name = DbFields.TRANSACTION_FEE, columnDefinition = "DECIMAL(32, 16)")
