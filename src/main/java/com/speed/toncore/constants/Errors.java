...
public class Errors {
	...
	public final String ERROR_DEPLOY_FEE_ACCOUNT = "Failed to deploy fee account for address %s";
	public final String ERROR_DEPLOY_MAIN_ACCOUNT = "Failed to deploy main account for address %s";
	...
	public final String ERROR_ON_CHAIN_RAW_TX = "Error while performing on-chain transaction: %s";
	...
	public final String ERROR_SUBSCRIBE_JETTON_LISTENER = "Error in rebooting the on chain token listener. Shutting down the current listener.";
	...
	public final String FEE_ACCOUNT_NOT_FOUND = "Speed ton fee account not found";
	...
	public final String ERROR_ON_SWEEP_TRANSACTION = "Error while performing sweep transaction: %s";
	public final String MAIN_ACCOUNT_NOT_FOUND = "Speed ton main account not found";
